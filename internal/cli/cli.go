...
func Suggest(docPath, docOutputPath string) (string, error) {
	// capping at 5 suggestions for demo
	out, err := runSpeakeasyCommand("suggest", "--schema", docPath, "--auto-approve", "--output-file", docOutputPath, "--max-suggestions", "5")
	if err != nil {
