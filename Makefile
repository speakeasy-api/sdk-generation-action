...
test-release-mode:
	docker compose run --build --rm main ./testing/test.sh ./testing/release-mode.env

test-release-mode-multi-sdk:
	docker compose run --build --rm main ./testing/test.sh ./testing/release-mode-multi-sdk.env

test-validate-action:
	docker compose run --build --rm main ./testing/test.sh ./testing/validate-action.env

test-overlay:
	docker compose run --build --rm main ./testing/test.sh ./testing/overlay-test.env
